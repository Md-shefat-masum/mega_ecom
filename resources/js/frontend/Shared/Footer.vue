                            ...
                            <div class="product-right">
                                <div class="pro-group">
                                    ...
                                    <div class="revieu-box">
                                        ...
                                        <a href="https://themes.pixelstrap.com/bigdeal/html/review.html"><span>(6
                                                reviews)</span></a>
                                    </div>
                                            ...
                                            <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path
                                                        ...
                                                        fill="#f9cc4e"></path>
                                                    <circle cx="64" cy="45.848" fill="#4ec4b5" r="29.146"></circle>
                                                    <path
                                ...
                                <div class="pro-group pb-0">
                                    <h6 class="product-title size-text">select size<span>
                                            <a href="https://themes.pixelstrap.com/bigdeal/html/layout-4.html"
            ...
            <div class="modal-content ">
                <div class="modal-body">
                    ...
                    <div class="pro-group mb-0">
                        <div class="modal-btn">
                            <a href="https://themes.pixelstrap.com/bigdeal/html/cart.html" class="btn btn-solid btn-sm">
                                add to cart
                            </a>
                            <a href="https://themes.pixelstrap.com/bigdeal/html/product-page(left-sidebar).html"
